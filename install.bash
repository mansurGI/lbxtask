...
docker exec database mariadb -u root -psTlInaYSVdVnmv9uYI2gfj --execute="create database if not exists app character set 'utf8mb4';"
docker exec database mariadb -u root -psTlInaYSVdVnmv9uYI2gfj --execute="create database if not exists test character set 'utf8mb4';"
